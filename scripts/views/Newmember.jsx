...
export default React.createClass({
    render(){
        return (<div className="col-md-8 col-md-offset-2 col-xs-12">
            ...
            <p>With the t-shirt in hand and after meeting with the board you will be able train together with us at the VKR and gain access to the Wiki and you will be added to the private FaceBook group and WhatsApp group. Furthermore we also hold the Strongest Student competition each year which can be a great moment to test your strength when you join us!</p>
