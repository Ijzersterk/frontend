...
default React.createClass({
    render() {
        return (<div className="col-md-6 col-md-offset-2 main">
                    ...
                    <p>
                        <span className="emp-red">Raising the bar</span>, that is our motto. We lift together, we yell at each other and we motivate each other to achieve that personal record on the squat, push ourselves just a little harder or just to become healthy.
                    </p>
